...
function ownerCosts(S){
  const vve=S.vveMonthly*S.months;
  const maintenance=S.maintenanceAnnual*S.months/12;
  const ownerTaxes=S.ownerTaxesAnnual*S.months/12;
  const insurance=S.insuranceAnnual*S.months/12;
  const groundLease=S.groundLeaseAnnual*S.months/12;
  const monthly=S.vveMonthly+(S.maintenanceAnnual+S.ownerTaxesAnnual+S.insuranceAnnual+S.groundLeaseAnnual)/12;
  return{monthly,vve,maintenance,ownerTaxes,insurance,groundLease,total:vve+maintenance+ownerTaxes+insurance+groundLease};
}
