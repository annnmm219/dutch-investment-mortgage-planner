...
'use strict';
const FC=window.FinanceCore,NE=window.NextEuroCore,OI=window.OutputIntegrity,$=id=>document.getElementById(id),clamp=FC.clamp;
if(!OI)throw new Error('OutputIntegrity must load before next-euro.js');
